import { UserPlus, Home, Users } from "lucide-react"
  ...
  const steps = [
    {
      ...
      description: "Complete a short form to tell us about your accommodation business.",
    },
    {
      icon: <Home className="h-10 w-10 text-[#C4704F]" />,
